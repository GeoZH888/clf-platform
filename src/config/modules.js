...
export const MODULES = [
  ...
  { id: 'riddles',    label: '猜灯谜',   icon: '🏮', gateable: true,  defaultEnabled: true,  category: 'games' , pillar: 'community' },
  { id: 'radicals',   label: '部首听音', icon: '🧩', gateable: true,  defaultEnabled: true,  category: 'games' , pillar: 'community' },  // 偏旁部首 + 读音 drill
  { id: 'compose',    label: '组字工坊', icon: '🧱', gateable: true,  defaultEnabled: true,  category: 'games' , pillar: 'community' },  // 义符+声符 composition
